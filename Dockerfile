...
COPY fetcher.py refresh_server.py models.py auth.py auth_validation.py web_server.py ai_service.py source_categories.py news_schema.py image_cache.py notifier.py .
